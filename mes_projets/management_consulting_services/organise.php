	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<!--<div class="search">
			<form action="#" class="header_search_form menu_mm">
				<input type="search" class="search_input menu_mm" placeholder="Rechercher" required="required">
		...
		<nav class="menu_nav">
			<ul class="main_nav">
				<li><a href="ecoles.php"><h4>Ecoles/Universités</h4></a></li>
				<li><a href="prestations.php"><h4>Nos prestations</h4></a></li>
				<li><a href="organise.php"><h4>S'organiser</h4></a></li>
				<li><a href="arrive_france.php"><h5>Une fois en France</h5></a></li>
				<li><a href="plus_mcs.php"><h4>Les + de mcs</h4></a></li>
				<!--<li class="active"><a href="contact.php"><h4>Contact</h4></a></li>-->
			</ul>
		</nav>
	</div>
		...
		<div class="container">
				...
				<div class="col">
					...
					<div class="blog_post trans_200">
							<!--<div class="blog_post_video_container">
								<video class="blog_post_video video-js" data-setup='{"controls": true, "autoplay": false, "preload": "auto", "poster": "images/admistratif.jpg"}'>
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">Visas et Cartes de séjours étudiants</a></div>
						...
						<div class="blog_post trans_200">
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">Trouver son logement en France</a></div>
								<!--<div class="blog_post_meta">
									<ul>
										<li><a href="#">Texte</a></li>
										<li><a href="#">Texte</a></li>
					...
					<div class="blog_post trans_200">
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">Ouvrir un compte bancaire</a></div>
								<!--<div class="blog_post_meta">
									<ul>
										<li><a href="#">Texte</a></li>
										<li><a href="#">Texte</a></li>
					...
					<div class="blog_post trans_200">
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">Travailler pendant ses études</a></div>
								<!--<div class="blog_post_meta">
									<ul>
										<li><a href="#">Texte</a></li>
										<li><a href="#">Texte</a></li>
						...
						<div class="blog_post trans_200">
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">La Contribution Vie Etudiante et de Campus (CVEC)</a></div>
								<!--<div class="blog_post_meta">
									<ul>
										<li><a href="#">Trouver une insciption</a></li>
						...
						<div class="blog_post trans_200">
							<!--<div class="blog_post_video_container">
								<video class="blog_post_video video-js" data-setup='{"controls": true, "autoplay": false, "preload": "auto", "poster": "images/visa.jpg"}'>
									<source src="images/mov_bbb.mp4" type="video/mp4">
									<source src="images/mov_bbb.ogg" type="video/ogg">
									Texte
								</video>
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">Les services d'accueil dans votre ville</a></div>
								<!--<div class="blog_post_meta">
									<ul>
										<li><a href="#">Obtenir un visa</a></li>
										<li><a href="#">VLTS</a></li>
									</ul>
								</div>-->
								<!--<div class="blog_post_text">
						...
						<div class="blog_post trans_200">
							<!--<div class="blog_post_video_container">
								<video class="blog_post_video video-js" data-setup='{"controls": true, "autoplay": false, "preload": "auto", "poster": "images/logement.jpg"}'>
									<source src="images/mov_bbb.mp4" type="video/mp4">
									<source src="images/mov_bbb.ogg" type="video/ogg">
									Texte
								</video>
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">Les droits d'assurances santé</a></div>
								<!--<div class="blog_post_meta">
									<ul>
										<li><a href="#">Demande de logement</a></li>
										<li><a href="#">Crous/logement individuel</a></li>
									</ul>
								</div>-->
								<!--<div class="blog_post_text">
									<p>Texte</p>
						...
						<div class="blog_post trans_200">
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">Préparation de son budget annuel</a></div>
								<!--<div class="blog_post_meta">
									<ul>
										<li><a href="#">Texte</a></li>
										<li><a href="#">Texte</a></li>
						...
						<div class="blog_post trans_200">
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">Trouver un parrain étudiant</a></div>
								<!--<div class="blog_post_meta">
									<ul>
										<li><a href="#">Texte</a></li>
										<li><a href="#">Texte</a></li>
						...
						<div class="blog_post trans_200">
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">Organiser son séjour en tant que boursier</a></div>
								<!--<div class="blog_post_meta">
									<ul>
										<li><a href="#">Texte</a></li>
										<li><a href="#">Texte</a></li>
						...
						<div class="blog_post trans_200">
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">Être étudiant en situation de handicap en France</a></div>
								<!--<div class="blog_post_meta">
									<ul>
										<li><a href="#">Texte</a></li>
										<li><a href="#">Texte</a></li>
						...
						<div class="blog_post trans_200">
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">Préparer son départ et son arrivée</a></div>
								<!--<div class="blog_post_meta">
									<ul>
										<li><a href="#">Texte</a></li>
										<li><a href="#">Texte</a></li>
						...
						<div class="blog_post trans_200">
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">Apprendre le français</a></div>
								<!--<div class="blog_post_meta">
									<ul>
										<li><a href="#">Texte</a></li>
										<li><a href="#">Texte</a></li>
						...
						<!--<div class="blog_post trans_200">
							...
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="">Texte</a></div>
								<div class="blog_post_meta">
									<ul>
										<li><a href="#">Texte</a></li>
										<li><a href="#">Texte</a></li>
			...
			<!--<div class="row">
				<div class="col text-center">
					<div class="load_more trans_200"><a href="#">Documentation</a></div>
				</div>
			</div>-->
		</div>
	</div>
